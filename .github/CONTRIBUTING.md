# Contributing Guidelines for airplo-stream
...
## Contents
- [Contributing Guidelines for airplo-stream](#contributing-guidelines-for-airplo-stream)
  - [Contents](#contents)
...
There are two places where to request features or report bugs:
 - GitHub Issues
 - The airplo-stream Discord server
...
### GitHub Issues
To make a GitHub issue for airplo-stream, please visit the [new issue page](https://github.com/sussy-code/smov/issues/new/choose) where you can pick either the "Bug Report" or "Feature Request" template.
...
GitHub issues are how we track our bugs and feature requests that will be implemented into airplo-stream - all contributions **must** have an issue and be approved by a maintainer before a pull request can be worked on.
...
## Contributing
If you're here because you'd like to work on an issue, amazing! Thank you for even considering contributing to airplo-stream; it means a lot :heart:
...
Our recommended development environment to work on airplo-stream is:
...
- Keep as much as possible to the style of airplo-stream. Look around our codebase to familiarise yourself with how we do things!
...
Language contributions help airplo-stream massively, allowing people worldwide to use our app!
